...
public class DialogForRec extends JDialog implements ActionListener {
    ...
    public DialogForRec(Frame parent) {
    ...
    protected static ImageIcon createImageIcon(String path) {        
        ...
        java.net.URL imgURL = DialogForRec.class.getResource(path);
        if (imgURL != null) {
