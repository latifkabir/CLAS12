...
public class DCTimeFunction
{
	...
	public double nonLinearFit()
	{
		...
		// b4 = -6.5;
		//
		// //if (histTypeToUseInFitting == 3) { //For other cases the b-field parameters will be
		// fixed to nominal values
		// if (histTypeToUseInFitting > 1) { //For other cases the b-field parameters will be fixed
		// to nominal values
